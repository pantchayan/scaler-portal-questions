...
test("Verify that clicking on inactive delete button turns the background color of the div.remove-btn to 'inherit'", async () => {
  ...
  const check = await page.evaluate((body) => {
    ...
    return removeBtn.style.backgroundColor === "inherit";
  }, bodyHandle);
