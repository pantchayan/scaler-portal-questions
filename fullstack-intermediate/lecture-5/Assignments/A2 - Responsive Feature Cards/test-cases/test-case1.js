// Description:
// Verify that a Media query for screens smaller than 940px (max-width: 939px) is written.
...
test("Verify that a Media query for screens smaller than 940px (max-width: 939px) is written.", async () => {
