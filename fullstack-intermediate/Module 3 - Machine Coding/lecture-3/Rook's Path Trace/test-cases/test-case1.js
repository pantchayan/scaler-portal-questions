...
test("clicking on a checkbox, the program traces the path of Rook from that checkbox.", async () => {
  ...
  const check = await page.evaluate((body) => {
    ...
    function checkRookTraceByIndex(idx) {
      let directionArr = [
        [0, 1],
        [0, -1],
        [-1, 0],
    ...
    let flag = checkRookTraceByIndex(10);
    return { flag, arr };
  }, bodyHandle);
